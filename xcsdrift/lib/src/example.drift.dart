...
typedef $ExampleCreateCompanionBuilder = i1.ExampleCompanion Function({
  ...
  i0.Value<i4.Multimap<String, String>?> labels,
...
class Example extends i0.Table with i0.TableInfo<Example, i1.ExampleData> {
  ...
  i1.ExampleData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return i1.ExampleData(
      ...
      labels: i1.Example.$converterlabelsn.fromSql(attachedDatabase.typeMapping
...
class ExampleData extends i0.DataClass
  ...
  final i4.Multimap<String, String>? labels;
  ...
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || labels != null) {
      map['labels'] =
          i0.Variable<String>(i1.Example.$converterlabelsn.toSql(labels));
    }
  ...
  factory ExampleData.fromJson(Map<String, dynamic> json,
    ...
    return ExampleData(
      ...
      labels: i1.Example.$converterlabelsn
  ...
  Map<String, dynamic> toJson({i0.ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'labels': serializer.toJson<Map<String, dynamic>?>(
          i1.Example.$converterlabelsn.toJson(labels)),
      'acl': serializer
...
class ExampleCompanion extends i0.UpdateCompanion<i1.ExampleData> {
  ...
  final i0.Value<i4.Multimap<String, String>?> labels;
  ...
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    ...
    if (labels.present) {
      map['labels'] =
          i0.Variable<String>(i1.Example.$converterlabelsn.toSql(labels.value));
    }
    if (acl.present) {
      map['acl'] =
