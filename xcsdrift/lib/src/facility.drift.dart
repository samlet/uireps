...
class Facility extends i0.Table with i0.TableInfo<Facility, i1.FacilityData> {
  ...
  i1.FacilityData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return i1.FacilityData(
      ...
      labels: i1.Facility.$converterlabelsn.fromSql(attachedDatabase.typeMapping
...
class FacilityData extends i0.DataClass
  ...
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || labels != null) {
      map['labels'] =
          i0.Variable<String>(i1.Facility.$converterlabelsn.toSql(labels));
    }
  ...
  factory FacilityData.fromJson(Map<String, dynamic> json,
    ...
    return FacilityData(
      ...
      labels: i1.Facility.$converterlabelsn
  ...
  Map<String, dynamic> toJson({i0.ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'labels': serializer.toJson<Map<String, dynamic>?>(
          i1.Facility.$converterlabelsn.toJson(labels)),
  ...
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    ...
    if (labels.present) {
      map['labels'] = i0.Variable<String>(
          i1.Facility.$converterlabelsn.toSql(labels.value));
    }
    if (acl.present) {
      map['acl'] =
