...
class $MarketplaceFilterComposer
    extends i0.Composer<i0.GeneratedDatabase, i1.Marketplace> {
  $MarketplaceFilterComposer({
    required super.$db,
  ...
  i0.ColumnFilters<String> get adminId => $composableBuilder(
      column: $table.adminId, builder: (column) => i0.ColumnFilters(column));
  ...
  i0.ColumnFilters<String> get realmId => $composableBuilder(
      column: $table.realmId, builder: (column) => i0.ColumnFilters(column));

  i0.ColumnFilters<double> get amount => $composableBuilder(
      column: $table.amount, builder: (column) => i0.ColumnFilters(column));

  i0.ColumnFilters<String> get marketplaceErcId => $composableBuilder(
      column: $table.marketplaceErcId,
      builder: (column) => i0.ColumnFilters(column));
  ...
  i0.ColumnWithTypeConverterFilters<List<i3.MarketplaceMultisig>?,
      ...
      get marketplaceMultisig => $composableBuilder(
          column: $table.marketplaceMultisig,
          builder: (column) => i0.ColumnWithTypeConverterFilters(column));
...
class $MarketplaceOrderingComposer
  ...
  i0.ColumnOrderings<String> get adminId => $composableBuilder(
      column: $table.adminId, builder: (column) => i0.ColumnOrderings(column));
  ...
  i0.ColumnOrderings<String> get realmId => $composableBuilder(
      column: $table.realmId, builder: (column) => i0.ColumnOrderings(column));

  i0.ColumnOrderings<double> get amount => $composableBuilder(
      column: $table.amount, builder: (column) => i0.ColumnOrderings(column));

  i0.ColumnOrderings<String> get marketplaceErcId => $composableBuilder(
      column: $table.marketplaceErcId,
      builder: (column) => i0.ColumnOrderings(column));
  ...
  i0.ColumnOrderings<String> get marketplaceMultisig => $composableBuilder(
      column: $table.marketplaceMultisig,
      builder: (column) => i0.ColumnOrderings(column));
...
class $MarketplaceAnnotationComposer
    extends i0.Composer<i0.GeneratedDatabase, i1.Marketplace> {
  $MarketplaceAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  i0.GeneratedColumn<String> get adminId =>
  ...
  i0.GeneratedColumn<String> get realmId =>
      $composableBuilder(column: $table.realmId, builder: (column) => column);

  i0.GeneratedColumn<double> get amount =>
      $composableBuilder(column: $table.amount, builder: (column) => column);

  i0.GeneratedColumn<String> get marketplaceErcId => $composableBuilder(
      column: $table.marketplaceErcId, builder: (column) => column);
  ...
  i0.GeneratedColumnWithTypeConverter<List<i3.MarketplaceMultisig>?, String>
      get marketplaceMultisig => $composableBuilder(
          column: $table.marketplaceMultisig, builder: (column) => column);
...
class $MarketplaceTableManager extends i0.RootTableManager<
    ...
    i1.$MarketplaceAnnotationComposer,
  ...
  $MarketplaceTableManager(i0.GeneratedDatabase db, i1.Marketplace table)
      : super(i0.TableManagerState(
          ...
          createFilteringComposer: () =>
              i1.$MarketplaceFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              i1.$MarketplaceOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              i1.$MarketplaceAnnotationComposer($db: db, $table: table),
