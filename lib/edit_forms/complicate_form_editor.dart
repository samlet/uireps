...
class SectionsApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: "model_editors Example",
      home: BooksSectionEditorPage(),
...
class _BooksSectionEditorPageState extends State<BooksSectionEditorPage> {
  ...
  void _onSavePressed() {
    ...
    for (var value in items) {
      print('- ${value.title}, ${value.author}: ${value.formats}');
    }
  }
