...
String _$defaultNoteHash() => r'b1ba735c2dbe2316b8309d617a66e2f6adc7e919';

/// See also [defaultNote].
@ProviderFor(defaultNote)
final defaultNoteProvider = AutoDisposeFutureProvider<Note>.internal(
  defaultNote,
  name: r'defaultNoteProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$defaultNoteHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef DefaultNoteRef = AutoDisposeFutureProviderRef<Note>;
...
String _$httpConnectorHash() => r'85f07fc5242fd63fffa481c2630afd7e5c6d90b2';

/// See also [httpConnector].
@ProviderFor(httpConnector)
final httpConnectorProvider = AutoDisposeProvider<HttpConnector>.internal(
  httpConnector,
...
typedef HttpConnectorRef = AutoDisposeProviderRef<HttpConnector>;
