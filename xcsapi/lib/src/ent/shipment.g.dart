...
Shipment _$ShipmentFromJson(Map<String, dynamic> json) => Shipment()
  ...
  ..shipmentItemFeature = (json['shipmentItemFeature'] as List<dynamic>?)
      ...
      .toList()
  ..shipmentPackageRouteSeg = (json['shipmentPackageRouteSeg']
          as List<dynamic>?)
      ?.map((e) => ShipmentPackageRouteSeg.fromJson(e as Map<String, dynamic>))
      .toList()
  ...
  ..shipmentPackageContent = (json['shipmentPackageContent'] as List<dynamic>?)
      ?.map((e) => ShipmentPackageContent.fromJson(e as Map<String, dynamic>))
      .toList()
...
Map<String, dynamic> _$ShipmentPackageRouteSegToJson(
  ...
  writeNotNull('labelPrinted', _$IndicatorEnumMap[instance.labelPrinted]);
