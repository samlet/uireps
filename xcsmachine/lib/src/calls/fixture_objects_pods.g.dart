...
String _$fixturesPrintProtoHash() =>
    r'2842aefcf98d17877397f4243c36418982f07035';

/// See also [fixturesPrintProto].
@ProviderFor(fixturesPrintProto)
const fixturesPrintProtoProvider = FixturesPrintProtoFamily();

/// See also [fixturesPrintProto].
class FixturesPrintProtoFamily extends Family<AsyncValue<String>> {
  /// See also [fixturesPrintProto].
  const FixturesPrintProtoFamily();

  /// See also [fixturesPrintProto].
  FixturesPrintProtoProvider call({
    String regionOrNs = 'default',
    required DecimalMap numMap,
  }) {
    return FixturesPrintProtoProvider(
      regionOrNs: regionOrNs,
      numMap: numMap,
    );
  }
  ...
  @override
  FixturesPrintProtoProvider getProviderOverride(
    covariant FixturesPrintProtoProvider provider,
  ) {
    return call(
      regionOrNs: provider.regionOrNs,
  ...
  @override
  String? get name => r'fixturesPrintProtoProvider';
}

/// See also [fixturesPrintProto].
class FixturesPrintProtoProvider extends AutoDisposeFutureProvider<String> {
  /// See also [fixturesPrintProto].
  FixturesPrintProtoProvider({
    String regionOrNs = 'default',
    required DecimalMap numMap,
  }) : this._internal(
          (ref) => fixturesPrintProto(
            ref as FixturesPrintProtoRef,
            regionOrNs: regionOrNs,
            numMap: numMap,
          ),
          from: fixturesPrintProtoProvider,
          name: r'fixturesPrintProtoProvider',
          debugGetCreateSourceHash:
              const bool.fromEnvironment('dart.vm.product')
                  ? null
                  : _$fixturesPrintProtoHash,
          dependencies: FixturesPrintProtoFamily._dependencies,
          allTransitiveDependencies:
              FixturesPrintProtoFamily._allTransitiveDependencies,
          regionOrNs: regionOrNs,
          numMap: numMap,
        );

  FixturesPrintProtoProvider._internal(
    super._createNotifier, {
    required super.name,
    required super.dependencies,
    required super.allTransitiveDependencies,
  ...
  final String regionOrNs;
  final DecimalMap numMap;

  @override
  Override overrideWith(
    FutureOr<String> Function(FixturesPrintProtoRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
      override: FixturesPrintProtoProvider._internal(
        (ref) => create(ref as FixturesPrintProtoRef),
        from: from,
        name: null,
        dependencies: null,
        allTransitiveDependencies: null,
  ...
  @override
  AutoDisposeFutureProviderElement<String> createElement() {
    return _FixturesPrintProtoProviderElement(this);
  }

  @override
  bool operator ==(Object other) {
    return other is FixturesPrintProtoProvider &&
        other.regionOrNs == regionOrNs &&
        other.numMap == numMap;
  }
...
mixin FixturesPrintProtoRef on AutoDisposeFutureProviderRef<String> {
  ...
  DecimalMap get numMap;
}

class _FixturesPrintProtoProviderElement
    extends AutoDisposeFutureProviderElement<String>
    with FixturesPrintProtoRef {
  _FixturesPrintProtoProviderElement(super.provider);

  @override
  String get regionOrNs => (origin as FixturesPrintProtoProvider).regionOrNs;
  @override
  DecimalMap get numMap => (origin as FixturesPrintProtoProvider).numMap;
}
...
String _$fixturesNoteEntsHash() => r'beb49b6c5b7daab333d9c9a08166663b8166a75a';

/// See also [fixturesNoteEnts].
@ProviderFor(fixturesNoteEnts)
const fixturesNoteEntsProvider = FixturesNoteEntsFamily();

/// See also [fixturesNoteEnts].
class FixturesNoteEntsFamily extends Family<AsyncValue<List<ProtoEnt>>> {
  /// See also [fixturesNoteEnts].
  const FixturesNoteEntsFamily();

  /// See also [fixturesNoteEnts].
  FixturesNoteEntsProvider call({
    String regionOrNs = 'default',
  }) {
    return FixturesNoteEntsProvider(
      regionOrNs: regionOrNs,
    );
  }

  @override
  FixturesNoteEntsProvider getProviderOverride(
    covariant FixturesNoteEntsProvider provider,
  ) {
    return call(
      regionOrNs: provider.regionOrNs,
    );
  ...
  @override
  String? get name => r'fixturesNoteEntsProvider';
}

/// See also [fixturesNoteEnts].
class FixturesNoteEntsProvider
    extends AutoDisposeFutureProvider<List<ProtoEnt>> {
  /// See also [fixturesNoteEnts].
  FixturesNoteEntsProvider({
    String regionOrNs = 'default',
  }) : this._internal(
          (ref) => fixturesNoteEnts(
            ref as FixturesNoteEntsRef,
            regionOrNs: regionOrNs,
          ),
          from: fixturesNoteEntsProvider,
          name: r'fixturesNoteEntsProvider',
          debugGetCreateSourceHash:
              const bool.fromEnvironment('dart.vm.product')
                  ? null
                  : _$fixturesNoteEntsHash,
          dependencies: FixturesNoteEntsFamily._dependencies,
          allTransitiveDependencies:
              FixturesNoteEntsFamily._allTransitiveDependencies,
          regionOrNs: regionOrNs,
        );

  FixturesNoteEntsProvider._internal(
    super._createNotifier, {
    required super.name,
    required super.dependencies,
    required super.allTransitiveDependencies,
  ...
  @override
  Override overrideWith(
    FutureOr<List<ProtoEnt>> Function(FixturesNoteEntsRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
      override: FixturesNoteEntsProvider._internal(
        (ref) => create(ref as FixturesNoteEntsRef),
        from: from,
        name: null,
        dependencies: null,
        allTransitiveDependencies: null,
  ...
  AutoDisposeFutureProviderElement<List<ProtoEnt>> createElement() {
    return _FixturesNoteEntsProviderElement(this);
  }

  @override
  bool operator ==(Object other) {
    return other is FixturesNoteEntsProvider && other.regionOrNs == regionOrNs;
  }
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin FixturesNoteEntsRef on AutoDisposeFutureProviderRef<List<ProtoEnt>> {
  /// The parameter `regionOrNs` of this provider.
  String get regionOrNs;
}

class _FixturesNoteEntsProviderElement
    extends AutoDisposeFutureProviderElement<List<ProtoEnt>>
    with FixturesNoteEntsRef {
  _FixturesNoteEntsProviderElement(super.provider);

  @override
  String get regionOrNs => (origin as FixturesNoteEntsProvider).regionOrNs;
}
...
String _$fixtureObjectsPodHash() => r'f9aeb77a1b8640727a540611c394349b3f64e8ce';
