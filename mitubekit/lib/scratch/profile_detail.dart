...
// https://www.flutterlibrary.com/screen-tag/profile
...
class Brand extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Text("blue.",
          style: TextStyle(fontWeight: FontWeight.w200, fontSize: 24.0, color: Colors.black87)),
      Text("cc",
          style: TextStyle(fontWeight: FontWeight.w800, fontSize: 18.0, color: Colors.purple))
    ]);
  }
}
