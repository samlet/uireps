...
final reclets = [configuratorAndDetailForm, recViewForm, signupForm, palletEntryForm, skuInfoForm, sourceLogsForm, configuratorForm, protoEntForm, metaEntryForm, noteContentForm, shelfForm, configItemForm, userInfoForm, typeInfoForm, configOptForm, testRecForm, spuInfoForm, helloPojoForm, commodityForm, fullIdForm, userObjForm]; 
