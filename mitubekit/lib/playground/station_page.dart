...
import '../utils/tesla_colors.dart';
import '../widgets/extra_info_widget.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const StationPage(title: 'Playground Page'),
    );
  }
}
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  SectionTitlePanel(title: 'About Station'),
                  SectionDescText(),

                  const SizedBox(height: 20),
                  SectionTitlePanel(title: 'Pricing'),
                  SectionPropPanel(),
                ],
              ),
            ),
...
class InfoCol2 extends StatelessWidget {
  const InfoCol2({
    super.key,
  });
...
class NameAndAddressPanel extends StatelessWidget {
  const NameAndAddressPanel({
    super.key,
  });
...
class SectionPropPanel extends StatelessWidget {
  const SectionPropPanel({
    super.key,
  });
...
class SectionDescText extends StatelessWidget {
  const SectionDescText({
    super.key,
  });
...
class SectionTitlePanel extends StatelessWidget {
  const SectionTitlePanel({
    super.key,
    required this.title,
  });
  final String title;
